...
<html lang="pt-br">
<head>
    <title>Pedreiro Paulo</title>
</head>

<body>
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Construção e Reforma de Prédios</h1>
        <p class="lead text-muted mb-0">Pensando em construir sua nova casa ou reformar algum edifício? Ofereço o melhor preço e maior garantia do mercado!</p>
    </div>
</section>
<div class="container">
    <div class="row">
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Construção Civil e Reforma</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="container">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <img class="d-block w-100" src="img/const1.png" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/const2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/const3.jfif" alt="Third slide">
    </div>
  </div>
                ...
                <div class="card-body">
                    <form method="get" action="cart.html">
                        <div class="form-group">
                            ...
                            <select class="custom-select" id="colors">
                                ...
                                <option value="2">Reforma ou Manutenção</option>
                            </select>
                        </div>
                        <!--<div class="form-group">
                    ...
                    <div class="product_rassurance">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><i class="fa fa-phone fa-2x"></i><br/>(55) 3585-1980</li>
                        </ul>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card border-light mb-3">
                ...
                <div class="card-body">
                    <p class="card-text">
                        Construção de casas, divisão de terrenos, assentamento de fundação para prédios e construção de pavimento. Reparos de rachaduras e manutenção para evitar quedas e outros problemas.
                    </p>
                    <p class="card-text">
                        Fornecendo aos clientes uma maior segurança, acredito que um bom serviço reflita na boa vontade do profissional.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card border-light mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="review">
                        ...
                        <p class="blockquote">
                            <p class="mb-0">Gostei bastante dos acabamentos em meu apartamento, ficou show!</p>
                        </p>
                        <hr>
                    </div>
                </div>
